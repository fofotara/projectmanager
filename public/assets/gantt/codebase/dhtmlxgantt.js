...
!function (t, e) {
    ...
    return function (t) {
        ...
        t.exports = function (t, e) {
            ...
            var i = e.posFromDate(t.start_date), n = e.posFromDate(t.end_date), r = Math.min(i, n) - 200,
                a = Math.max(i, n) + 200;
            return {top: e.getItemTop(t.id), height: e.getItemHeight(t.id), left: r, width: a - r}
        }
    }, function (t, e) {
        t.exports = function (t) {
            var e = [];
        ...
        t.exports = function (t) {
            ...
            return {
                getSum: function (t, e, i) {
                    ...
                    var e = this._isLegacyMode(t), n = t || i.config();
        ...
        var n = i(13), r = i(4), a = i(0), o = i(29), s = i(126), l = function (t, e, i, s) {
            this.$config = a.mixin({}, e || {}), this.$scaleHelper = new n(s), this.$gantt = s, this._posFromDateCache = {}, a.mixin(this, o()), r(this)
        };
        ...
        l.prototype = {
            init: function (t) {
                ...
                var t = this.$config.scrollLeft || 0, e = this.$config.scrollTop || 0, i = this.$config.height || 0,
                    n = this.$config.width || 0;
                return {y: e, y_end: e + i, x: t, x_end: t + n, height: i, width: n}
                ...
                var n = this.$getConfig(), r = this.$gantt.$services.templates(), a = [], o = null, s = null,
                    l = t.format || t.template || t.date;
                "string" == typeof l && (l = this.$gantt.date.date_to_str(l));
                var u = 0, d = t.count;
                !n.smart_scales || isNaN(e) || isNaN(i) || (u = c(t.left, e), d = c(t.left, i) + 1), s = t.css || function () {
                ...
                var n = Math.floor(i), r = i % 1, a = this._tasks.left[Math.min(n, this._tasks.width.length - 1)];
                ...
                var t = this.$getConfig(), e = this.$scaleHelper, i = [e.primaryScale(t)].concat(e.getSubScales(t));
                ...
                var t = this.$gantt;
                this._clearLayers(t), this._unbindStore(), this.$task = null, this.$task_scale = null, this.$task_data = null, this.$task_bg = null, this.$task_links = null, this.$task_bars = null, this.$gantt = null, this.$config.rowStore && (this.$config.rowStore.detachEvent(this._staticBgHandler), this.$config.rowStore = null), this.$config.linkStore && (this.$config.linkStore = null), this.callEvent("onDestroy", []), this.detachAllEvents()
            }
        }, t.exports = l
    }, function (t, e) {
        t.exports = function (t) {
        ...
        function a(t) {
            var e = function (t) {
                var e = new r(t).primaryScale(), i = e.unit, a = e.step;
                if (t.config.scale_offset_minimal) {
                    var o = new n(t), s = [o.primaryScale()].concat(o.getSubScales());
                    o.sortScales(s), i = s[s.length - 1].unit, a = s[s.length - 1].step || 1
                }
                return {unit: i, step: a}
            }(t), i = e.unit, a = e.step, o = function (t, e) {
        ...
        var n = i(24), r = i(0), a = i(4), o = function (t) {
        ...
        var n = i(1), r = i(0), a = i(4), o = i(125), s = i(29), l = function (t, e, i, n) {
        ...
        l.prototype = {
            init: function (t) {
                ...
                var l = o(e, this);
                l.init(), this._renderHeaderResizers = l.doOnRender, this._mouseDelegates = i(12)(e), this._addLayers(this.$gantt), this._initEvents(), this.callEvent("onReady", [])
        ...
        t.exports = function (t) {
            ...
            t.assert = i(36)(t), t.init = function (t, e, i) {
        ...
        t.exports = function (t) {
            var e = i(1), n = i(3), r = i(58)(t), a = i(57)(t), o = i(56)(t), s = i(9)(t), l = i(55)(t), c = i(54)(t),
                u = i(53)(t), d = i(52)(t), h = i(9)(t), f = i(51)(t);
        ...
        var n = i(69), r = i(64), a = i(62), o = i(0);
        t.exports = function (t) {
        ...
        t.exports = function (t) {
            ...
            t.load = function (e, i, n) {
                ...
                parse: function (i) {
                    if (i || e(i), "string" == typeof i) if (window.JSON) try {
                        i = JSON.parse(i)
                    } catch (t) {
                        e(i)
        ...
        "use strict";
        Object.defineProperty(e, "__esModule", {value: !0});
        var n = i(8), r = i(4), a = ["ctrlKey", "altKey", "shiftKey", "metaKey"],
            o = [[{unit: "month", date: "%M", step: 1}, {unit: "day", date: "%d", step: 1}], [{
                unit: "day",
                date: "%d %M",
                step: 1
                ...
                date: "%d %M",
                step: 1
            }, {unit: "hour", date: "%H:00", step: 1}]], s = function () {
                function t(t) {
                    var e = this;
                    this.zoomIn = function () {
                        ...
                        -1 === i && e.$gantt.assert(-1 !== i, "Invalid zoom level for gantt.ext.zoom.setLevel. " + t + " is not an expected value."), e._setLevel(i, 0)
                    }, this._getZoomIndexByName = function (t) {
                        var i = -1;
                        if ("string" == typeof t) {
                            if (!isNaN(Number(t)) && e._levels[Number(t)]) i = Number(t); else for (var n = 0; n < e._levels.length; n++) if (e._levels[n].name === t) {
                                i = n;
                                break
                            }
                        } else i = t;
                        ...
                        var t = e.$gantt.getScrollState().x, i = e.$gantt.$task.offsetWidth;
                        e._visibleDate = e.$gantt.dateFromPos(t + i / 2)
                    }, this._setLevel = function (t, i) {
                        e._activeLevelIndex = t;
                        var n = e.$gantt, r = n.copy(e._levels[e._activeLevelIndex]), a = n.copy(r);
                        ...
                        var i = e.$gantt.$task.getBoundingClientRect().x, n = t.clientX - i, r = !1;
        ...
        function a(t) {
            ...
            function l(n, r, a, o) {
                ...
                return e[s] ? e[s] : e[s] = function (e, n, r, a) {
                    ...
                    for (var o = r.unit, s = r.step, l = {}, c = 0; c < p.length; c++) for (var u = p[c], d = t.date[o + "_start"](new Date(u.start_date)); d < u.end_date;) {
                        var h = d;
                        if (d = t.date.add(d, s, o), t.isWorkTime({date: h, task: u, unit: o})) {
                            var f = h.valueOf();
                            l[f] || (l[f] = []), l[f].push(u)
                        }
                    }
            ...
            function d(t, e, i) {
                var n = e.width[t], r = e.left[t] - n, a = e.left[t] + n;
                ...
                renderLine: function () {
                    ...
                    return {
                        render: function (i, n, r) {
                            var a = n.$getConfig(), o = n.$getTemplates(), s = n.getScale(),
                                c = l(i, a.resource_property, n.getScale(), n), u = [];
                            t[i.id] = {};
                            for (var h = 0; h < c.length; h++) {
                                var f = c[h], _ = s.trace_indexes[f.start_date.valueOf()];
                                if (d(_, s, r)) {
                                    var g = e(i, f, o, a, n);
                            ...
                            var p = null;
                            if (u.length) for (p = document.createElement("div"), h = 0; h < u.length; h++) p.appendChild(u[h]);
                            return p
                            ...
                            for (var s = a.$getConfig(), c = a.$getTemplates(), u = a.getScale(), h = l(n, s.resource_property, a.getScale(), a), f = 0; f < h.length; f++) {
                                var _ = h[f], g = u.trace_indexes[_.start_date.valueOf()];
                                if (d(g, u, o)) if (t[n.id] && t[n.id][g]) t[n.id] && t[n.id][g] && !t[n.id][g].parentNode && r.appendChild(t[n.id][g]); else {
                                    var p = e(n, _, c, s, a);
                    ...
                    function o(e, i, r, a, o, s, l) {
                        ...
                        var f = function (e, i, n, r) {
                            for (var a = i.getScale(), o = document.createElement("div"), s = 0; s < a.trace_x.length; s++) if (d(s, a, r)) {
                                var l = a.trace_x[s], h = a.trace_x[s + 1] || t.date.add(l, a.step, a.unit),
                                    f = a.trace_x[s].valueOf(), _ = Math.min(e[f] / n, 1) || 0;
                                if (_ < 0) return null;
                                var g = Math.min(e[h.valueOf()] / n, 1) || 0, p = c(_, l, h, i);
                                p && o.appendChild(p);
                    ...
                    return {
                        render: function (t, r, a) {
                            var c = r.$getConfig(), u = r.$getTemplates(), h = r.getScale(),
                                f = l(t, c.resource_property, h, r), _ = [], g = {},
                                p = t.capacity || r.$config.capacity || 24;
                            e[t.id] = {}, i[t.id] = null, n[t.id] = null;
                            for (var v = 0; v < f.length; v++) {
                                var m = f[v], y = h.trace_indexes[m.start_date.valueOf()];
                                if (d(y, h, a)) {
                                    var b = u.histogram_cell_capacity(m.start_date, m.end_date, t, m.tasks);
                                    g[m.start_date.valueOf()] = b || 0;
                                    var k = r.getItemPosition(t, m.start_date, m.end_date), w = s(t, k, p, c, u, m);
                                    w && (_.push(w), e[t.id][y] = w)
                                }
                            }
                            var x = null;
                            if (_.length) {
                                for (x = document.createElement("div"), v = 0; v < _.length; v++) x.appendChild(_[v]);
                                var $ = o(t, k, g, c, r, p, a);
                                $ && (x.appendChild($), n[t.id] = $), i[t.id] = x
                            }
                            return x
                            ...
                            for (var u = r.$getConfig(), h = r.$getTemplates(), f = r.getScale(), _ = l(t, u.resource_property, f, r), g = t.capacity || r.$config.capacity || 24, p = {}, v = 0; v < _.length; v++) {
                                var m = _[v], y = f.trace_indexes[m.start_date.valueOf()],
                                ...
                                if (d(y, f, c)) {
                                    var w = e[t.id];
                                    if (w && w[y]) w && w[y] && !w[y].parentNode && i.appendChild(w[y]); else {
                                        var x = s(t, k, g, u, h, m);
                                        x && (i.appendChild(x), e[t.id][y] = x)
                                    }
                                } else a(t.id, y)
                            }
                            var $ = o(t, k, p, u, r, g, c);
                            $ && (i.appendChild($), n[t.id] = $)
                        }, getRectangle: r
                    }
        ...
        t.exports = function (t) {
            ...
            function h() {
                var e = !!document.querySelector(".gantt_drag_marker"),
                    ...
                    n = !!document.querySelector(".gantt_link_direction"), r = t.getState(), a = r.autoscroll;
            ...
            function g(e) {
                ...
                u = {x: e.clientX, y: e.clientY}, !o && i && _(!0)
            }

            function p() {
                if (!h()) return _(!1), !1;
                var e = n.getNodePosition(d(t.$task) ? t.$task : d(t.$grid) ? t.$grid : t.$root), r = u.x - e.x,
                    a = u.y - e.y, o = s ? 0 : v(r, e.width, c.x - e.x), l = v(a, e.height, c.y - e.y),
                    f = t.getScrollState(), g = f.y, p = f.inner_height, m = f.height, y = f.x, b = f.inner_width,
                    k = f.width;
        ...
        t.exports = function (t) {
            t.ext || (t.ext = {});
            for (var e = [i(84), i(83), i(82), i(81), i(80), i(79), i(78), i(77)], n = 0; n < e.length; n++) e[n] && e[n](t);
            var r = i(76).default;
            t.ext.zoom = new r(t)
        }
    }, function (t, e, i) {
        ...
        var n = i(3), r = function () {
            ...
            return t.prototype.attach = function () {
                var t = this.$dp, e = this.$gantt, n = i(22), r = {};
        ...
        "use strict";
        Object.defineProperty(e, "__esModule", {value: !0});
        var n = i(4), r = i(3), a = i(0), o = i(87), s = i(86);
        ...
        var n = i(24), r = i(0), a = i(25), o = function (t) {
        ...
        var n = i(0), r = i(94), a = i(93), o = i(25), s = i(92), l = i(91), c = i(90);
                    ...
                    this._legacyGridResizerClass(e), e.attachEvent("onBeforeResize", function () {
                        ...
                        if (a) {
                            ...
                            if (a.$config.hidden = a.$parent.$config.hidden = !o, !a.$config.hidden) {
                                ...
                                } else a.$parent._setContentSize(a.$config.width, null), t.$layout._syncCellSizes(a.$parent.$config.group, t.config.grid_width); else r && n.isChildOf(r.$task, e.$view) && (a.$config.original_grid_width = t.config.grid_width), i || (a.$parent.$config.width = 0)
                            }
                            i = !1
                        }
        ...
        var n = i(1), r = function (t, e) {
            ...
            var _ = new f(t.$task_bars, {sensitivity: 0, updates_per_second: 60});
            ...
            function p(t, i) {
                var n = _.getPosition(t), r = function (t) {
                        var e = 0, i = 0;
                        return t && (e = t.offsetWidth || 0, i = t.offsetHeight || 0), {width: e, height: i}
                    }(i), a = function () {
                        var t = e.$root;
                    ...
                    d = {y: n.y + s, x: n.x + o, bottom: n.y + r.height + s + u, right: n.x + r.width + o + u};
                return d.bottom > a.bottom && (d.y = a.bottom - r.height - s), d.right > a.right && (d.x = a.right - r.width - o), d
            }

            function v(t) {
                var i = u(), n = ["gantt_link_tooltip"];
            ...
            function y(i, n, r, a) {
                ...
                if (c = Math.max(0, c - 3)) {
                    o.className = l.join(" ");
                    var d = (a - n) / (r - i), h = Math.atan(d);
                    2 == b(i, r, n, a) ? h += Math.PI : 3 == b(i, r, n, a) && (h -= Math.PI);
                    var f = Math.sin(h), g = Math.cos(h), p = Math.round(n), v = Math.round(i),
            ...
            _.attachEvent("onBeforeDragStart", e.bind(function (i, r) {
                ...
                var u = !!n.locateClassName(s, "gantt_link_control"), d = r, h = i, f = a, m = e.locate(s), b = !0;
                if (n.isChildOf(s.target || s.srcElement, e.$root) || (u = !1, m = null), u && (b = !n.locateClassName(s, "task_end_date"), u = !!m), r = m, i = u, a = b, u) {
                    var k = e.getTask(m), w = t.$getConfig(), x = n.locateClassName(s, "gantt_link_control"), $ = 0;
        ...
        var n = i(0), r = i(101), a = i(100), o = i(1), s = function (t) {
            var e = t.$services;
            return {
                onCreated: function (e) {
                    var o = e.$config;
                    o.bind = n.defined(o.bind) ? o.bind : "task", o.bindLinks = n.defined(o.bindLinks) ? o.bindLinks : "link", e._linksDnD = a.createLinkDND(), e._tasksDnD = r.createTaskDND(), e._tasksDnD.extend(e), this._mouseDelegates = i(12)(t)
                }, onInitialized: function (e) {
        ...
        var n = i(1), r = i(10), a = i(105), o = i(104), s = i(103);
        t.exports = {
            init: function (t, e) {
        ...
        var n = i(0), r = i(107), a = i(106), o = function (t) {
            return {
                onCreated: function (e) {
                    e.$config = n.mixin(e.$config, {bind: "task"}), "grid" == e.$config.id && (this.extendGantt(e), t.ext.inlineEditors = t.ext._inlineEditors.createEditors(e), t.ext.inlineEditors.init()), this._mouseDelegates = i(12)(t)
                }, onInitialized: function (e) {
                    var i = e.$getConfig();
        ...
        t.exports = function (t) {
            return {
                render: function (e, i, r) {
                    var a = i.getGridColumns(), o = i.$getConfig(), s = i.$getTemplates(), l = i.$config.rowStore;
                    o.rtl && (a = a.reverse());
                    for (var c = [], u = 0; u < a.length; u++) {
                        var d, h, f, _ = u == a.length - 1, g = a[u];
                        "add" == g.name ? (h = "<div " + (b = t._waiAria.gridAddButtonAttrString(g)) + " class='gantt_add'></div>", f = "") : (h = g.template ? g.template(e) : e[g.name], n.isDate(h) && (h = s.date_grid(h, e)), null !== h && void 0 !== h || (h = ""), f = h, h = "<div class='gantt_tree_content'>" + h + "</div>");
        ...
        t.exports = function (t, e, i) {
            ...
            var r = n(i.getTask(t.source), e, i), a = n(i.getTask(t.target), e, i);
            if (!r || !a) return null;
            var o = Math.min(r.left, a.left) - 100, s = Math.max(r.left + r.width, a.left + a.width) + 100,
                l = Math.min(r.top, a.top) - 100;
            return {top: l, height: Math.min(r.top + r.height, a.top + a.height) + 100 - l, left: o, width: s - o}
        }
    }, function (t, e, i) {
        var n = i(110);
        t.exports = function (t) {
            var e = {
                ...
                path: [], clear: function () {
                    ...
                    var n = i.$getConfig(), a = this.get_line_type(e, n), o = a.from_start, s = a.to_start,
                        l = t.getTask(e.source), c = t.getTask(e.target), u = r(l, i), d = r(c, i);
            ...
            return {
                render: function (n, r) {
                    ...
                    var g = c[c.length - 1].direction, p = function (t, i, n) {
                        var r = n.$getConfig(), a = document.createElement("div"), o = t.y, s = t.x,
                            l = r.link_arrow_size, c = r.row_height, u = "gantt_link_arrow gantt_link_arrow_" + i;
                        switch (i) {
                            case e.dirs.right:
                                o -= (l - c) / 2, s -= l;
                                break;
        ...
        t.exports = function (t) {
            ...
            return {
                render: function (n, o, s) {
                    var u = o.$getConfig(), d = o.$getTemplates(), h = o.getScale(), f = h.count;
                    ...
                    var y = t.getGlobalTaskIndex(n.id) % 2 != 0, b = d.task_row_class(n.start_date, n.end_date, n),
                    ...
                    var d = r.$getConfig(), h = r.getScale(), f = h.count, _ = l(r);
        ...
        var n = i(11), r = i(27);
        t.exports = function (t) {
            return {render: r(t), update: null, getRectangle: n}
        }
    }, function (t, e) {
        t.exports = function (t) {
        ...
        var n = i(123), r = i(120), a = i(119), o = i(118), s = i(117), l = i(116), c = i(0), u = i(1), d = i(4),
            h = i(115);
        ...
        t.exports = function (t) {
            ...
            d(i);
            var r = {
                init: f, createEditors: function (n) {
                    function r(t, e) {
                        var i = function (t, e) {
                    ...
                    var a = h(t), o = [], s = null, l = {
                        ...
                        save: function () {
                            if (this.isVisible() && s.exists(this._itemId) && this.isChanged()) {
                                ...
                                if (s.exists(e)) {
                                    var r = s.getItem(e), o = this.getEditorConfig(i), l = {
                                        id: e,
                                        columnName: i,
                    ...
                    return c.mixin(l, e), c.mixin(l, i), l
                }
            };
        ...
        var n = i(2), r = i(1), a = i(0), o = i(8), s = function (t) {
            "use strict";
        ...
        var n = i(2), r = i(30), a = i(7), o = function (t) {
            "use strict";
        ...
        var n = i(131), r = i(15), a = i(31);
        t.exports = function (t) {
            var e = t.$services, i = {}, o = {};
                ...
                return u && u.setAttribute(e.config().layer_attribute, !0), o[l] = {
                    render_item: function (e, i, a) {
                        ...
                        if (a && a.$getConfig().smart_rendering && !r(t) && this.rendered && f) {
                            i = i || u;
                            var o = document.createDocumentFragment(), l = null;
                            a && (l = a.getViewPort());
                            for (var d = 0, _ = e.length; d < _; d++) {
                                var g = e[d], p = this.rendered[g.id];
                    ...
                    }, rendered: i[l], node: u, destructor: function () {
            ...
            return {
                getRenderer: l, clearRenderers: function () {
                    for (var t in o) l(t).destructor()
                }
            }
        }
    }, function (t, e, i) {
        var n = i(132), r = i(0), a = i(1), o = i(15);
                ...
                createGroup: function (i, n, l, c) {
                    var u = {
                        tempCollection: [], renderers: {}, container: i, filters: [], getLayers: function () {
                            ...
                            for (var o = this.container(), s = this.tempCollection, l = 0; l < s.length; l++) if (i = s[l], this.container() || i && i.container && a.isChildOf(i.container, document.body)) {
                                var u = i.container, d = i.id, h = i.topmost;
        ...
        t.exports = function (t) {
            ...
            return {
                getDataRender: function (e) {
                    ...
                    var n = i.name, a = i.defaultContainer, o = i.defaultContainerSibling,
                    ...
                    return {
                        addTaskLayer: function (t) {
                            ...
                            return "function" == typeof t && (t = {renderer: t}), t.view = "timeline", i.addLayer(t)
        ...
        var n = i(137), r = i(135), a = i(134), o = i(7), s = i(30), l = i(130), c = i(129), u = i(128), d = i(127),
            h = i(14), f = i(28), _ = i(28), g = i(14), p = i(14), v = i(124), m = i(114), y = i(113), b = i(112),
            k = i(111), w = i(109), x = i(108), $ = i(102), S = i(99);
        t.exports = {
            init: function (t) {
                function e(e, i) {
                    var n = i(t);
        ...
        (function (t) {
            ...
            }, i(140), e.setImmediate = "undefined" != typeof self && self.setImmediate || void 0 !== t && t.setImmediate || this && this.setImmediate, e.clearImmediate = "undefined" != typeof self && self.clearImmediate || void 0 !== t && t.clearImmediate || this && this.clearImmediate
        }).call(this, i(16))
    }, function (t, e, i) {
        (function (e, i, n) {
            t.exports = function () {
                    ...
                    1: [function (t, e, i) {
                        ...
                        i.exports = function (i, n) {
                            ...
                            i.config = function (t) {
                                ...
                                if ("cancellation" in t && t.cancellation && !Z.cancellation) {
                                    ...
                                    i.prototype._clearCancellationData = O, i.prototype._propagateFrom = M, i.prototype._onCancel = P, i.prototype._setOnCancel = L, i.prototype._attachCancellationCallback = A, i.prototype._execute = I, N = M, Z.cancellation = !0
                                }
                            ...
                            function B(t) {
                                for (var e = [], i = 0; i < t.length; ++i) {
                                    var n = t[i], r = "    (No stack trace)" === n || p.test(n), a = r && Y(n);
                            ...
                            return k && i.longStackTraces(), {
                                ...
                                }, CapturedTrace: J, fireDomEvent: $, fireGlobalEvent: S
                            }
                        }
                        ...
                        i.exports = function () {
                            ...
                            var p = function () {
                                ...
                                $ = (x.CapturedTrace, t("./finally")(D, y, m)), S = t("./catch_filter")(m),
                                T = t("./nodeback"), C = c.errorObj, E = c.tryCatch;
                            ...
                            return D.prototype.toString = function () {
                                ...
                                var i = arguments.length > 1 && !!Object(arguments[1]).multiArgs, n = E(t)(T(e, i));
                        ...
                        var j = void 0 !== e && "[object process]" === L(e).toLowerCase(),
        ...
        }).call(this, i(32), i(16), i(141).setImmediate)
    }, function (t, e, i) {
        t.exports = i(142)
    }, function (t, e, i) {
        var n = i(0);
        ...
        t.exports = function (t) {
            ...
            return {
                initTemplates: function () {
                    ...
                    var n = t.date, r = n.date_to_str, a = t.config, o = r(a.xml_date || a.date_format, a.server_utc),
                    ...
                    i("date_scale", !0, void 0, t.config, t.templates), i("date_grid", !0, "grid_date_format", t.config, t.templates), i("task_date", !0, void 0, t.config, t.templates), t.mixin(t.templates, {
                        xml_format: o, format_date: o, xml_date: s, parse_date: s, progress_text: function (t, e, i) {
                            return ""
                            ...
                            return ""
                        }, time_picker: r(a.time_picker), link_class: function (t) {
                            return ""
                        ...
                        }, tooltip_date_format: n.date_to_str("%Y-%m-%d"), tooltip_text: function (e, i, n) {
        ...
        i(18), t.exports = function () {
            var t = new function () {
                this.constants = i(153), this.version = "6.2.7", this.license = "gpl", this.templates = {}, this.ext = {}, this.keys = {
                    edit_save: this.constants.KEY_CODES.ENTER,
                    edit_cancel: this.constants.KEY_CODES.ESC
                }
            };
            i(152)(t), t.$services = t.$inject(i(151)), t.config = t.$inject(i(150)), t.ajax = i(149)(t), t.date = i(147)(t);
            var e = i(146)(t);
            ...
            r.registerProvider("global", function () {
                var e = {min_date: t._min_date, max_date: t._max_date, selected_task: null};
            ...
            var a = i(0);
            a.mixin(t, a), t.Promise = i(143), t.env = i(8);
            var o = i(1);
            t.utils = {
                dom: {
            ...
            var s = i(19)();
            t.event = s.attach, t.eventRemove = s.detach, t._eventRemoveAll = s.detachAll, t._createDomEventScope = s.extend, a.mixin(t, i(139)(t));
            var l = i(138).init(t);
            ...
            }), t.mixin(t, l.layersApi), i(98)(t), t.$services.setService("layers", function () {
                return l.layersService
            });
            var c = i(97);
            t.mixin(t, c()), i(96)(t);
            var u = i(89);
            return t.dataProcessor = u.DEPRECATED_api, t.createDataProcessor = u.createDataProcessor, i(85)(t), i(75)(t), i(74)(t), i(73)(t), i(72)(t), i(71)(t), i(70)(t), i(61)(t), i(60).default(t), i(59)(t), i(50)(t), i(49)(t), i(48)(t), i(47)(t), i(46)(t), i(45)(t), i(44)(t), i(43)(t), i(42)(t), i(41)(t), i(40)(t), i(39)(t), i(38)(t), i(37)(t), i(35)(t), i(34).default(t), t
        }
    }, function (t, e) {
        t.exports = function (t) {
        }
        ...
        "use strict";
        Object.defineProperty(e, "__esModule", {value: !0});
        var n = i(155), r = i(154), a = window.gantt = r();
